...
docker run -ti --entrypoint=/bin/bash --user nonroot --env DISPLAY=%IPv4%:%XLaunchScreenID% -e APP_HOME=/home/nonroot/project -p 127.0.0.1:8000:8000 -v "%cd%":/home/nonroot/project -w /home/nonroot/project/src dlbuesen/cv_sim_films_interactions:version-1.0-layer07
